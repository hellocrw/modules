package crw.demo.moduleservice.config;
...
public class SwaggerConfig {
    ...
    private static final String API_TITLe = "订单系统后端API";
    private static final String API_DESCRIPTION = "系统后台REST接口定义";
    private static final String API_LICENSE = "由crw开发编写";
    private static final String API_LICENSE_URL = "https://github.com/hellocrw/modules";
    ...
    private static final String API_BASE_PACKAGE = "crw.demo.moduleapi.controller";
    ...
    public Docket OrderApi(){
        return this.commonApi("Order Management", API_BASE_PACKAGE + ".order", true);
    }
