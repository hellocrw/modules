package crw.demo.moduleapi.config;
...
public class SwaggerConfig {
    ...
    private static final String API_TITLe = "多模块开发测试API";
    private static final String API_DESCRIPTION = "多模块开发后台REST接口定义";
    private static final String API_LICENSE = "crw开发编写";
